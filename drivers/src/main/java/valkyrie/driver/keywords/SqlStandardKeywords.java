...
public class SqlStandardKeywords
{
        ...
        static {
                ...
                Collections.addAll(keywords,
                        ...
                        "DISCONNECT:Keyword", "DISTINCT:Keyword", "DOUBLE:Keyword", "DROP:Keyword", "DYNAMIC:Keyword", "EACH:Keyword", "ELEMENT:Keyword", "ELSE:Keyword",
                        ...
                        "FUSION:Keyword", "GET:Keyword", "GLOBAL:Keyword", "GO:Keyword", "GOTO:Keyword", "GRANT:Keyword", "GROUP:Keyword", "GROUPING:Keyword", "HAVING:Keyword",
                        ...
                        "ISOLATION:Keyword", "JOIN:Keyword", "KEY:Keyword", "LANGUAGE:Keyword", "LARGE:Keyword", "LAST:Keyword", "LATERAL:Keyword", "LEADING:Keyword",
